...
<head>
    ...
    <script src="js/bootstrap.min.js" ></script>    <style>        body{
        ...
        <table class="table table-hover">
            ...
            <c:forEach items="${list}" var="alog">
                <tr>
                    ...
                    <td><a href="deletelend.html?sernum=<c:out value="${alog.sernum}"></c:out>" onclick="return confirm('确定要删除这条借还记录吗？')"><button type="button" class="btn btn-danger btn-xs">删除</button></a></td>
                </tr>
            </c:forEach>
            </tbody>
        </table>
