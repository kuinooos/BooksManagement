...
public class LendDao {
    ...
    // 添加删除借还记录的SQL语句
    private final static String DELETE_LEND_RECORD_SQL="DELETE FROM lend_list WHERE sernum = ? ";
    ...
    // 添加删除借还记录的方法
    public int deleteLendRecord(long sernum){
        return jdbcTemplate.update(DELETE_LEND_RECORD_SQL, sernum);
    }
}
